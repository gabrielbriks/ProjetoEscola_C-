<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Materias_Add.aspx.cs" Inherits="SchoolSystem.Materia_Add" %>
    ...
    <asp:Panel runat="server" ID="pnlCadastro" Visible="true">
        ...
        <ul>
            ...
            <li>
                ...
                <asp:Label ID="tbDataCadastro" runat="server" Text=""></asp:Label>
            </li>
